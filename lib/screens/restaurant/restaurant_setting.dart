...
class RestSetting extends StatefulWidget {
  final Users? user;

  const RestSetting({Key? key, required this.user}) : super(key: key);

  @override
  State<RestSetting> createState() => _RestSettingState();
}

class _RestSettingState extends State<RestSetting>
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Get.to(() => RestaurantProfile(user: widget.user));
                      },
