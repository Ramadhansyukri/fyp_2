...
class SetAddressScreen extends StatefulWidget {
  ...
  const SetAddressScreen({Key? key,required this.user, required this.updateAddress}) : super(key: key);
            ...
            children: [
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.fromLTRB(20, 5, 20, 5),
                    child: Text('Use Address'.toUpperCase(), style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white),),
                  ),
                  onPressed: () async{
